...
public class Customer {
    ...
    public void setCustomerNameKr(String customerNameKr) {
        this.customerNameKr = customerNameKr == null ? null : customerNameKr.trim();
    }
    ...
    public String getDevelopmentSkill() {
        return developmentSkill;
    }

    public void setDevelopmentSkill(String developmentSkill) {
        this.developmentSkill = developmentSkill == null ? null : developmentSkill.trim();
    }
