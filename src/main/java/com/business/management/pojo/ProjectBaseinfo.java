...
public class ProjectBaseinfo {
    ...
    public String getProjectSalesMan() {
        return projectSalesMan;
    }

    public void setProjectSalesMan(String projectSalesMan) {
        this.projectSalesMan = projectSalesMan == null ? null : projectSalesMan.trim();
    }
